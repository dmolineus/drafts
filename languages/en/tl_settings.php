...
$GLOBALS['TL_LANG']['tl_settings']['drafts_legend'] = 'Draft mode';
...
$GLOBALS['TL_LANG']['tl_settings']['draftsTaskDefaultDeadline'][1] = 'Task in task center is generated automatically. Please define the default deadline in days.';
$GLOBALS['TL_LANG']['tl_settings']['draftModeAsDefaultOptions'][1] = 'only for users without publish permissions';
$GLOBALS['TL_LANG']['tl_settings']['draftModeAsDefaultOptions'][2] = 'for anyone';
